 ...
 *       &lt;sequence>
 *         &lt;element name="reservations" type="{http://amss.com/XMLProjekat/dto/soap}reservationView" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetReservationsResponse {
    ...
    protected List<ReservationView> reservations;
    ...
    public List<ReservationView> getReservations() {
        if (reservations == null) {
            reservations = new ArrayList<ReservationView>();
        }
