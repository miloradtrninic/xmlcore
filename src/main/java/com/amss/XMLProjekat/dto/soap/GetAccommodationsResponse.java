 ...
 *       &lt;sequence>
 *         &lt;element name="accommodations" type="{http://amss.com/XMLProjekat/dto/soap}accommodationView" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAccommodationsResponse {
    ...
    protected List<AccommodationView> accommodations;
    ...
    public List<AccommodationView> getAccommodations() {
        if (accommodations == null) {
            accommodations = new ArrayList<AccommodationView>();
        }
